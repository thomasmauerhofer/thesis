...
\textit{TF-IDF} and \textit{BM$25$} need the inverted document frequency in addition to the term frequency. The inverse document frequency represents the importance of a term regarding the whole document collection.
