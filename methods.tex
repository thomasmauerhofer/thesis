...
The main properties of our citation network are shown at \Cref{tbl:general_properties_about_the_graph}. One important point is that there are no cycles, which can be also seen by the number of strongly connected components. The longest citation chain over the timeline is defined by the longest path.
