...
We invented a database schema which fits to the structure of a scientific article. The table named scientific article in the schema (see \Cref{fig:database_schema}) can be seen as the root node for each database entry.
