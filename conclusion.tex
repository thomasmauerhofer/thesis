...
In this chapter we give a short recap of the results obtained in \Cref{cha:results_discussion}. Afterward, these results are discussed against each other to generate an overarching view of them.
...
% 1 + 2 not combareable as user has different requirements... 
