...
This can be seen as the main question of the thesis. It describes weather the adapted algorithms can achieve better results with the useage of IMRaD-Structure Information than the standard version of the algorithms.
...
The standard version of the used ranking algorithms search for query words in the whole document. The left part of \Cref{fig:implicit_vs_explicit} shows our adaption with the usage of structural information. There the user can define in which chapters the query words should occur.
