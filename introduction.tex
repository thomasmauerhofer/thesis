...
In our first research question we are focusing on the explicit search. This means that query words and chapters where they occur are part of the query. The hypothesis is that used keywords vary in different areas. Therefore a more targeted search is possible if a user can specify where query words should occur (see \Cref{fig:implicit_vs_explicit} a).
