...
Zone scores $zs$ have to be defined to configure \textit{Ranked Boolean Retrieval}. For the experiments the zones scores are determined through a param search, and defined as follows:
\begin{align*}
  zs_{\text{Title}} & = 0.2                \nonumber \\
...
\end{align*}
where "Title" defines the header of the document component, "Text" the text area of the of the document component. Fur further information about structured text retrieval, document components, and \textit{Ranked Boolean Retrieval} see \Cref{sec:structured_text_Retrieval}.

The ranking of the proposed ranking algorithms was generated with respect to their achieved accuracy when IMRaD chapter features are enabled. The best performing algorithm is \textit{TF-IDF} with a accuracy of $0.1613$ with enabled features, and $0.1163$ with disabled features.
...
Discussion,   0.1188, 0.1078, 0.0957, 0.0914, 0.084
  ...
  \caption[Chapter based Search using TF-IDF]{\textbf{Chapter based Search using TF-IDF.} Describe me...}
...
Discussion,   0.0799, 0.0682, 0.0587, 0.0595, 0.0616
  ...
  \caption[Chapter based Search using Okapi BM$25$]{\textbf{Chapter based Search using Okapi BM$25$.}  Describe me...}
