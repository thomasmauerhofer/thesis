...
In our first experiments we compare unstructured text retrieval with structured text retrieval. Therefore, each document in the dataset contains multiple sets of index terms (see \Cref{sec:model} for the definition of the document). For structured text retrieval, we focus on the underlying IMRaD structure.
