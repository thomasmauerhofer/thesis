...
% write about tf-idf to compute the score as it is described in book...
% Bla blub described in this work how to use the tf-idf as a ranking algorithm without any knowledge about vector operations. There....
