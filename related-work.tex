...
To improve the results of term frequency weights, inverse document frequency weights are used in combination. The concept of inverse document frequency was introduced by Spärck Jones ~\cite{jones72astatistical}, and is a foundation in term weighting. % statistical research...

The Zipf's Law ~\cite{zipf1932selected} was used as base to create the inverse document frequency:
\begin{align}
  IDF_i = \log \frac{N}{n_i}
\end{align}
Describe the values in the formula...

To use the term frequency weight in combination with the inverse document frequency weight formula ~\ref{raw_tf} has to be adopted:
\begin{equation}
...
% write about the combination of both...
