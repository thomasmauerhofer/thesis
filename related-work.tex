...
\begin{itemize}
  ...
  \item The \textit{Methods} section should answer the questions when, where, and how the study was done. Additionally, it contains information about the used materials.
...
Day ~\cite{robert1989} proposed in his work that the first IMRaD-like writing structure was generated by \textit{Louis Pasteur} with his book in \textit{"Etudes sur la Biere"} originally published in $1876$. In the book \textit{Introduction}, \textit{Methods} and \textit{Discussion} can be found although the headings of the section were different. Sollaci and Pereira ~\cite{Sollaci-The-2004} describe in their work that the IMRaD structure began to be adopted in the $1940$s. Furthermore, they proposed that it became to the standard format for scientific articles in the $1970$s.
