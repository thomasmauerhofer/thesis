...
The degree of similarity between a document $d_j$, and a query $q$ is calculated by the cosine of the angle between their underlying vectors. The calculation is as follows:
\begin{equation}
  \begin{split}
...
\subsubsection{Term Frequency-Inverse Document Frequency Weights}
\label{sec:tfidf}
